              ...
              <div className="absolute top-2 bottom-2 left-[22%] flex w-[44%] items-center rounded-lg bg-primary px-2 text-primary-foreground shadow-sm">
                <div className="flex items-center gap-2">
                  ...
                  <div className="min-w-0">
                    <div className="truncate text-xs font-medium leading-none text-primary-foreground">
                      Demonstração de produto com Tim
                    </div>
        ...
        <CardContent className="flex flex-col gap-1">
          <div className="flex items-end justify-between gap-3">
            <div className="text-2xl font-medium leading-none tabular-nums">
              {proposalSent} <span className="text-base font-normal text-muted-foreground">enviadas</span>
            </div>
            <div className="text-sm tabular-nums text-muted-foreground">{proposalGoal} meta</div>
          </div>
