...
// Série sintética (mesma forma/magnitude do bloco de referência CRM) — sem dado real de negócio.
            ...
            <div className="flex flex-col gap-5 rounded-lg p-4 lg:col-span-4">
              <div className="flex flex-col gap-1">
                <div className="text-4xl font-medium leading-none tabular-nums">
                  {totalQualified} <span className="text-lg font-normal text-muted-foreground">leads</span>
                </div>
                <p className="text-sm text-muted-foreground">Total de leads qualificados captados nos últimos 12 meses.</p>
              </div>

              <div className="flex flex-col gap-3 rounded-lg border border-border/60 p-3">
                <div className="text-[11px] uppercase tracking-widest text-muted-foreground">
                  Ligações de descoberta agendadas
                </div>

                <div className="flex flex-col gap-1.5">
                  <div className="text-2xl font-medium leading-none tabular-nums">
                    {discoveryCallsBooked} <span className="text-sm font-normal text-muted-foreground">reuniões</span>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    {discoveryProgress}% dos leads qualificados agendaram uma primeira ligação.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 pt-0.5">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <div className="font-medium tabular-nums">{discoveryCallsBooked} agendadas</div>
