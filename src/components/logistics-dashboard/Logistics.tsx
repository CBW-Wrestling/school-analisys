...
export function Logistics() {
  ...
  return (
    <>
      <div className="grid h-[calc(100vh-14rem)] min-h-[560px] overflow-hidden rounded-xl border lg:grid-cols-[400px_minmax(0,1fr)] lg:divide-x">
      ...
      <Sheet open={detailsOpen} onOpenChange={setDetailsOpen}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{selectedShipment ? `Remessa #${selectedShipment.id}` : 'Detalhes da remessa'}</SheetTitle>
            <SheetDescription>Detalhes da remessa selecionada e mapa da rota.</SheetDescription>
          </SheetHeader>
          <ShipmentDetails shipment={selectedShipment} />
        </SheetContent>
      </Sheet>
