...
export const filters = {
  ...
  team: [ALL_FILTER, ...teamValues],
  status: [ALL_FILTER, 'Active', 'Pending invite', 'Deactivated', 'Locked', 'Suspended'],
  workspace: [ALL_FILTER, 'Weblabs Studio', 'Sandbox', 'Internal Tools', 'Acme Inc.'],
}
