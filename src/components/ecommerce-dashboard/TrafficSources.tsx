import { ArrowUpRight, Globe, Share2, ShoppingBag, Store, Video } from 'lucide-react'
...
export function TrafficSources() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-sm font-normal text-muted-foreground">Fontes de tráfego</CardTitle>
