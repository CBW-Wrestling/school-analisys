      ...
      <div>
        <div className="grid grid-cols-1 xl:grid-cols-12">
          <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-3 xl:col-span-5 xl:border-r">
            <Card className="h-full rounded-none border-0 border-b border-border ring-0 md:border-r">
              <CardHeader>
                <CardTitle className="text-sm font-normal">Vendas totais</CardTitle>
            ...
            <Card className="h-full rounded-none border-0 border-b border-border ring-0">
              <CardHeader>
                <CardTitle className="text-sm font-normal">Pedidos totais</CardTitle>
                <CardDescription className="text-3xl leading-none tracking-tight text-foreground tabular-nums">
                  379
                </CardDescription>
                <CardAction className="grid size-6 place-items-center rounded-sm bg-muted">
            ...
            <Card className="h-full rounded-none border-0 border-b border-border ring-0 md:border-r">
              <CardHeader>
                <CardTitle className="text-sm font-normal">Crescimento de clientes</CardTitle>
                <CardDescription className="text-3xl leading-none tracking-tight text-foreground tabular-nums">
                  820
                </CardDescription>
                <CardAction className="grid size-6 place-items-center rounded-sm bg-muted">
            ...
            <Card className="h-full rounded-none border-0 border-b border-border ring-0">
              <CardHeader>
                <CardTitle className="text-sm font-normal">Ticket médio</CardTitle>
                <CardDescription className="text-3xl leading-none tracking-tight text-foreground tabular-nums">
                  $128
                </CardDescription>
                <CardAction className="grid size-6 place-items-center rounded-sm bg-muted">
            ...
            <Card className="h-full rounded-none border-0 border-b border-border ring-0 md:border-r md:border-b-0">
              <CardHeader>
                <CardTitle className="text-sm font-normal">Solicitações de devolução</CardTitle>
                <CardDescription className="text-3xl leading-none tracking-tight text-foreground tabular-nums">
                  18
                </CardDescription>
                <CardAction className="grid size-6 place-items-center rounded-sm bg-muted">
            ...
            <Card className="h-full rounded-none border-0 ring-0">
              <CardHeader>
                <CardTitle className="text-sm font-normal">Acurácia de estoque</CardTitle>
                <CardDescription className="text-3xl leading-none tracking-tight text-foreground tabular-nums">
                  97%
                </CardDescription>
                <CardAction className="grid size-6 place-items-center rounded-sm bg-muted">
              ...
              <CardContent>
                <div className="text-sm">
                  ...
                  <span className="text-muted-foreground"> vs. última auditoria</span>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="h-full rounded-none border-0 ring-0 xl:col-span-7">
            <CardHeader>
              <CardTitle className="font-normal">Visão geral de vendas</CardTitle>
              <CardAction>
