...
const tasks: Task[] = [
  { title: 'Finalizar roteiro do trimestre', tag: 'Trabalho', time: '10:00', checked: false },
  { title: 'Revisar atualizações do design system', tag: 'Design', time: '11:30', checked: true },
  { title: 'Responder e-mails importantes', tag: 'Admin', time: '14:00', checked: false },
  { title: 'Planejar conteúdo da semana', tag: 'Conteúdo', time: '16:30', checked: false },
  { title: 'Preparar notas do sync semanal', tag: 'Planejamento', time: '18:00', checked: false },
]
