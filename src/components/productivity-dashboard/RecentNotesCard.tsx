...
const recentNotes = [
  ...
  { title: `Ideias de conteúdo – ${format(today, 'MMMM', { locale: ptBR })}`, date: formatNoteDate(subDays(today, 1)), icon: FileText },
  { title: 'Aprendizados da semana', date: formatNoteDate(subDays(today, 4)), icon: FileText },
