...
const projects = [
  {
    title: 'Roteiro do trimestre',
    status: 'Em andamento',
    description: 'Entregar melhor, entregar mais rápido.',
    progress: 68,
    due: `Prazo ${format(addDays(today, 9), 'd MMM', { locale: ptBR })}`,
    icon: Orbit,
  },
  {
    ...
    progress: 42,
    due: `Prazo ${format(addDays(today, 21), 'd MMM', { locale: ptBR })}`,
    icon: Globe,
  },
  {
    title: 'Onboarding',
    status: 'Planejamento',
    description: 'Reduzir etapas da primeira execução.',
    progress: 31,
    due: `Prazo ${format(addDays(today, 18), 'd MMM', { locale: ptBR })}`,
    icon: ClipboardCheck,
  },
] as const
